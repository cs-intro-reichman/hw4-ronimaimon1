...
public class ArrCharOps {
    ...
    public static boolean equals(char[] arr1, char[] arr2) {
        boolean equals = arr1.length == arr2.length; // check if the arrays are lengths equals
        for (int i=0; i<arr1.length; i++) // check if the 2 arrays have the same value in every index
            if (arr1[i]!=arr2[i]) {
                equals = !equals;
                break;
            }
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        char[] resault = new char[arr1.length+arr2.length];
        int j = 0;
